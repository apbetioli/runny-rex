...
namespace VoxelImporter
{
    public class VoxelHumanoidConfigreAvatar : EditorWindow
    {
        ...
        private void Initialize(VoxelSkinnedAnimationObject animationObject)
        {
            ...
            avatarIcon = EditorGUIUtility.Load("icons/processed/avatar icon.asset") as Texture2D;
#else
            avatarIcon = EditorGUIUtility.Load("icons/generated/avatar icon.asset") as Texture2D;
#endif
...
#region Avatar Icon
            {
                EditorGUILayout.BeginHorizontal();
                {
                    ...
                    EditorGUI.LabelField(rect, animationObject.avatar.name);
                }
...
#region Done
        ...
        private void GUI_InspectorBone(string name, bool required, VoxelSkinnedAnimationObject.HumanoidBone select)
        {
            ...
            var bone = animationObject.humanDescription.bones[(int)select];
            ...
            }
            {
                ...
                if (EditorGUI.EndChangeCheck())
                {
                    if (boneTmp == null || boneTmp.voxelObject == animationObject)
                    {
                        ...
                        animationObject.humanDescription.bones[(int)select] = boneTmp;
                    }
                }
            }
            EditorGUILayout.EndHorizontal();
        ...
        {
            if (animationObject.humanDescription.bones[(int)VoxelSkinnedAnimationObject.HumanoidBone.Head] == null) return false;
        ...
        {
            if (animationObject.humanDescription.bones[(int)VoxelSkinnedAnimationObject.HumanoidBone.Hips] == null ||
                animationObject.humanDescription.bones[(int)VoxelSkinnedAnimationObject.HumanoidBone.Spine] == null) return false;
        ...
        {
            if (animationObject.humanDescription.bones[(int)VoxelSkinnedAnimationObject.HumanoidBone.LeftUpperArm] == null ||
                animationObject.humanDescription.bones[(int)VoxelSkinnedAnimationObject.HumanoidBone.LeftLowerArm] == null ||
                animationObject.humanDescription.bones[(int)VoxelSkinnedAnimationObject.HumanoidBone.LeftHand] == null) return false;
        ...
        private bool IsLeftFingersHave()
        {
            ...
            {
                if (animationObject.humanDescription.bones[(int)i] != null)
                    return true;
            }
        ...
        {
            if (animationObject.humanDescription.bones[(int)VoxelSkinnedAnimationObject.HumanoidBone.LeftUpperLeg] == null ||
                animationObject.humanDescription.bones[(int)VoxelSkinnedAnimationObject.HumanoidBone.LeftLowerLeg] == null ||
                animationObject.humanDescription.bones[(int)VoxelSkinnedAnimationObject.HumanoidBone.LeftFoot] == null) return false;
        ...
        {
            if (animationObject.humanDescription.bones[(int)VoxelSkinnedAnimationObject.HumanoidBone.RightUpperArm] == null ||
                animationObject.humanDescription.bones[(int)VoxelSkinnedAnimationObject.HumanoidBone.RightLowerArm] == null ||
                animationObject.humanDescription.bones[(int)VoxelSkinnedAnimationObject.HumanoidBone.RightHand] == null) return false;
        ...
        {
            if (animationObject.humanDescription.bones[(int)VoxelSkinnedAnimationObject.HumanoidBone.RightUpperLeg] == null ||
                animationObject.humanDescription.bones[(int)VoxelSkinnedAnimationObject.HumanoidBone.RightLowerLeg] == null ||
                animationObject.humanDescription.bones[(int)VoxelSkinnedAnimationObject.HumanoidBone.RightFoot] == null) return false;
        ...
        {
            var bone = animationObject.humanDescription.bones[(int)boneIndex];

            if (bone == null) return false;

            int count = 0;
            for (int i = 0; i < (int)VoxelSkinnedAnimationObject.HumanoidBone.Total; i++)
            {
            ...
            {
                string names = "";
                for (VoxelSkinnedAnimationObject.HumanoidBone i = 0; i < VoxelSkinnedAnimationObject.HumanoidBone.Total; i++)
                {
                    if (i != boneIndex && animationObject.humanDescription.bones[(int)i] == bone)
                    {
                        if (string.IsNullOrEmpty(names)) names = i.ToString();
                        else names += ", " + i.ToString();
                    }
                }
        ...
        private bool IsBoneTransformParentError(VoxelSkinnedAnimationObject.HumanoidBone boneIndex, ref string errorMessage)
        {
            ...
            Func<VoxelSkinnedAnimationObject.HumanoidBone, bool> CheckTransform = (checkIndex) =>
            {
                ...
                {
                    var checkBone = animationObject.humanDescription.bones[(int)checkIndex];
                    if (checkBone == null)
                    {
                ...
                if (boneParent != checkTransform)
                    errorParent = checkIndex;

                return boneParent == checkTransform;
            };
            ...
            if (!result)
            {
                var boneError = animationObject.humanDescription.bones[(int)errorParent];
                if (boneError != null)

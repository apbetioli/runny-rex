                    ...
                    #region Bone Animation Editor
                    {
                        editorBoneEditorWindowRect = GUILayout.Window(EditorGUIUtility.GetControlID(FocusType.Passive, editorBoneEditorWindowRect), editorBoneEditorWindowRect, (id) =>
                        {
                            ...
                            #region Mirror
                            {
                                ...
                                EditorGUI.BeginChangeCheck();
                                var edit_mirrorSetBoneAnimation = EditorGUILayout.ToggleLeft(string.Format("Set to mirror bone\n ({0})", boneTarget.mirrorBone != null ? boneTarget.mirrorBone.name : "none"), boneTarget.edit_mirrorSetBoneAnimation, GUILayout.Height(32));
                                if (EditorGUI.EndChangeCheck())
                                {
                    ...
                    #region Bone Position Editor
                    {
                        editorBoneEditorWindowRect = GUILayout.Window(EditorGUIUtility.GetControlID(FocusType.Passive, editorBoneEditorWindowRect), editorBoneEditorWindowRect, (id) =>
                        {
                            ...
                            #region Mirror
                            {
                                EditorGUI.BeginDisabledGroup(boneTarget.mirrorBone == null);
                                EditorGUI.BeginChangeCheck();
                                var edit_mirrorSetBonePosition = EditorGUILayout.ToggleLeft(string.Format("Set to mirror bone\n ({0})", boneTarget.mirrorBone != null ? boneTarget.mirrorBone.name : "none"), boneTarget.edit_mirrorSetBonePosition, GUILayout.Height(32));
                                if (EditorGUI.EndChangeCheck())
                                {
                        ...
                        #region Bone Weight Editor
                        {
                            editorBoneEditorWindowRect = GUILayout.Window(EditorGUIUtility.GetControlID(FocusType.Passive, editorBoneEditorWindowRect), editorBoneEditorWindowRect, (id) =>
                            {
                                ...
                                #region Mirror
                                {
                                    EditorGUI.BeginDisabledGroup(boneTarget.mirrorBone == null);
                                    EditorGUI.BeginChangeCheck();
                                    var edit_mirrorSetBoneWeight = EditorGUILayout.ToggleLeft(string.Format("Set to mirror bone\n ({0})", boneTarget.mirrorBone != null ? boneTarget.mirrorBone.name : "none"), boneTarget.edit_mirrorSetBoneWeight, GUILayout.Height(32));
                                    if (EditorGUI.EndChangeCheck())
                                    {
                                        Undo.RecordObject(boneTarget, "Mirror");
